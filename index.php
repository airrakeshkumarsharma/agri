        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="form-group">
                        <button name="submit"  class="btn float-right login_btn" >Login</button>
                    </div>
                    <div class="form-group">
                        <a href="signup.php"  class="btn float-left login_btn" >SIGNUP</a>
                    </div>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center links">
                   <a> Don't have an account?Sign Up ABOVE</a>
                </div>
